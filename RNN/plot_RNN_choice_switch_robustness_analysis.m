function plot_RNN_choice_switch_robustness_analysis

close all
clear all
clc

% Plot perturbation-induced choice switching in RNNs using different choice mode durations (0.5 or 1.5 s).
% Select a folder containing data.
folder_name = uigetdir;
cd(folder_name)

% Choice mode duration from 5 s to 5.5 s.
load('RNN_choice_switch_trial_fraction_robustness_analysis.mat')

switch_trial_fraction_control_no_ablation = RNN_choice_switch_trial_fraction_robustness_analysis.shorter_choice_epoch.control.no_ablation;
switch_trial_fraction_control_ablation_10_percent = RNN_choice_switch_trial_fraction_robustness_analysis.shorter_choice_epoch.control.ablation_10_percent;
switch_trial_fraction_control_ablation_20_percent = RNN_choice_switch_trial_fraction_robustness_analysis.shorter_choice_epoch.control.ablation_20_percent;
switch_trial_fraction_APP_no_ablation = RNN_choice_switch_trial_fraction_robustness_analysis.shorter_choice_epoch.APP.no_ablation;
...
% Choice mode duration from 4 s to 5.5 s.
clearvars -except folder_name
load('RNN_choice_switch_trial_fraction_robustness_analysis.mat')

switch_trial_fraction_control_no_ablation = RNN_choice_switch_trial_fraction_robustness_analysis.longer_choice_epoch.control.no_ablation;
switch_trial_fraction_control_ablation_10_percent = RNN_choice_switch_trial_fraction_robustness_analysis.longer_choice_epoch.control.ablation_10_percent;
switch_trial_fraction_control_ablation_20_percent = RNN_choice_switch_trial_fraction_robustness_analysis.longer_choice_epoch.control.ablation_20_percent;
switch_trial_fraction_APP_no_ablation = RNN_choice_switch_trial_fraction_robustness_analysis.longer_choice_epoch.APP.no_ablation;
mean_switch_trial_fraction_control_no_ablation = mean(switch_trial_fraction_control_no_ablation);
mean_switch_trial_fraction_control_ablation_10_percent = mean(switch_trial_fraction_control_ablation_10_percent);
mean_switch_trial_fraction_control_ablation_20_percent = mean(switch_trial_fraction_control_ablation_20_percent);
mean_switch_trial_fraction_APP_no_ablation = mean(switch_trial_fraction_APP_no_ablation);
